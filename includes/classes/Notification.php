...
class Notification {
	...
	public function getNotifications($data, $limit) {
		...
		while ($row = mysqli_fetch_array($query)) {
			...
			$user_data_query = mysqli_query($this->con, "SELECT * FROM USER WHERE USERNAME='$user_from'");
	...
	public function insertNotification($post_id, $user_to, $type) {
		...
		$insert_query = mysqli_query($this->con, "INSERT INTO NOTIFICATIONS VALUES(NULL,'$user_to','$userLoggedIn','$message','$link','$datetime','no','no')");
	}
