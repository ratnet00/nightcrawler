...
class Post {
	...
	public function submitPost($body, $user_to, $imageName) {
		...
		if($check_empty != "") {
			...
			//insert post in DB
			$query = mysqli_query($this->con, "INSERT INTO MEDIA VALUES(NULL,'$body','$added_by','$user_to','$date_added','no','0', '$imageName')");
